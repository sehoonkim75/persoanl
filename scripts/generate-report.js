  ...
  "sections": [
    {
      ...
      "overview": "3~4문장 개요",
      "cards": [
        { "tag": "태그", "title": "소제목", "body": "3문장 내용", "color": "red" },
        { "tag": "태그", "title": "소제목", "body": "3문장 내용", "color": "blue" },
        { "tag": "태그", "title": "소제목", "body": "3문장 내용", "color": "green" }
      ],
      "chartTitle": null,
      "chartData": [],
      "expandItems": [
      ...
      "callout": { "text": "주요 시사점", "color": "blue" },
      "keywords": [
...
규칙: stats 5개, sections 3개(s01~s03), 각 섹션 cards 2~4개, 실제 기업명·수치 포함`;
...
출력 스키마:
{
  "sections": [
    ...
    { "id": "s06", "num": "06", "title": "HR 트렌드 심층 분석", "icon": "🔬", ... }
  ],
  "editorNote": "편집장 총평 3~4문장",
  "nextIssue": "다음 호 예고"
}

규칙: sections 3개(s04~s06), editorNote·nextIssue 필수, 실제 기업명·수치 포함`;
...
function parseJSON(raw) {
  ...
  const tries = [
    () => JSON.parse(s),
    () => JSON.parse(s.replace(/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F]/g, "")),
    () => {
  ...
  for (const fn of tries) { try { return fn(); } catch (_) {} }
